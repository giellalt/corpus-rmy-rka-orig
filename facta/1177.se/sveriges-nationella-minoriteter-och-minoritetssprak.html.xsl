...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Romanska-kalderash/Sveriges-nationella-minoritetssprak/Sveriges-nationella-minoriteter-och-minoritetssprak'"/>
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="mainlang" select="'rmy-rka'"/>
    ...
    <language xml:lang="rmy-rka"/><language xml:lang="swe"/></xsl:variable>
